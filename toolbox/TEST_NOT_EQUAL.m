...
%   TEST_NOT_EQUAL(__,name)
%   passed = TEST_NOT_EQUAL(__)
%
% See also TEST_EQUAL.
%
...
%
%==========================================================================
function passed = TEST_NOT_EQUAL(X1,X2,n,name)
    ...
    if passed
        ...
        if n_min == 0
            result = strcat('ERROR -- Equal to ',n,' decimal places.');
        else
            result = strcat('ERROR -- Equal to ',n,' decimal places. ',...
                data_type,' ARE NOT equal to ',n_min,' decimal places.');
        end
    end
