...
%     function correctly throws errors when subject to specific inputs, we
%     do not care about any return values.
%
%==========================================================================
function output = TEST_ERROR(f,args,name,print,color)
